...
Share links give each recipient their own copy, kept in sync through GitHub. For real-time editing where everyone works on one live server instead, see the [Remote Control overview](/docs/remote-control/overview).

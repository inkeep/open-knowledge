...
Share links give each recipient their own copy, kept in sync through GitHub. For real-time editing where everyone works on one live server instead, see [Remote access](/docs/deploy/remote-access).

...
Serve this project's web UI and `/mcp` endpoint to your other devices through any HTTPS tunnel, both on one URL. See the [self-hosting overview](/docs/self-hosting/overview) for the full setup and access-control model. Use [Connect remote agents](/docs/self-hosting/connecting-agents) to point agents at the URL.

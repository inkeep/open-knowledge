---
title: LM Studio
description: Use OpenKnowledge with local models in LM Studio over MCP.
icon: LuCpu
---

[LM Studio](https://lmstudio.ai) is a desktop app for running open models locally. It's an [MCP](https://modelcontextprotocol.io) **host** — its chat connects to MCP servers — so once OpenKnowledge is registered, a locally-hosted model can read, search, and write your knowledge base through OK's tools, with full attribution, link-awareness, conflict-awareness, and a live browser preview. Nothing leaves your machine: both the model and the knowledge base run locally.

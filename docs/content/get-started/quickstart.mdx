...
<Callout type="info" title="Prerequisites">
  - **macOS** on Apple Silicon (M1 or later), **Windows 10+** (x64 or Arm64), or **Linux** (a Debian/Ubuntu or Fedora/RHEL family distro, x64 or arm64).
  - **`git`.** OpenKnowledge initializes a git repo for your project (used for the timeline and recovery features). macOS includes it with the Xcode Command Line Tools; on Windows or Linux, install it from [git-scm.com](https://git-scm.com) or your package manager.
</Callout>
...
Download the latest version of the OpenKnowledge desktop app for your platform. The button picks your platform automatically; use its dropdown for a different architecture or package format.

<DownloadButton />

**macOS** — open the DMG and drag **OpenKnowledge** to **Applications**. (Apple Silicon only; on an Intel Mac, use the [web app](#ok-install-web-app).)

**Windows** — download the installer for [x64](https://github.com/inkeep/open-knowledge/releases/latest/download/OpenKnowledge-Setup-x64.exe) or [Arm64](https://github.com/inkeep/open-knowledge/releases/latest/download/OpenKnowledge-Setup-arm64.exe) and run it. It installs per-user — no admin prompt — and adds OpenKnowledge to your Start menu.

**Linux** — download the package for your distro family and architecture ([.deb x64](https://github.com/inkeep/open-knowledge/releases/latest/download/OpenKnowledge-amd64.deb), [.deb arm64](https://github.com/inkeep/open-knowledge/releases/latest/download/OpenKnowledge-arm64.deb), [.rpm x64](https://github.com/inkeep/open-knowledge/releases/latest/download/OpenKnowledge-x86_64.rpm), [.rpm arm64](https://github.com/inkeep/open-knowledge/releases/latest/download/OpenKnowledge-aarch64.rpm)), then install it:

```bash
sudo apt install ./OpenKnowledge-amd64.deb   # Debian/Ubuntu
sudo dnf install ./OpenKnowledge-x86_64.rpm  # Fedora/RHEL
```
...
The same editor, served locally and opened in your browser — for any platform the desktop app doesn't cover (an Intel Mac, a server) or when you just prefer the terminal.

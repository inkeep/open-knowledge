...
// This harness requires POSIX login shells and signal semantics. The required
// Windows terminal job covers the packaged interactive marker path; this
// sustained flood/backpressure matrix remains POSIX-only.

/**
 * Descriptor-dispatch NodeView with zero permanent chrome: unknown and render-failed descriptors
 * auto-convert to an editable `rawMdxFallback` through direct PM dispatch (precedent #28), and

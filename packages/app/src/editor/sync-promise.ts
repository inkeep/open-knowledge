...
/**
 * Returning a pre-resolved promise here is what makes the "cold mount, warm content" path
 * (precedent #18(c)) work — without this gate, every Activity-evicted-but-pool-resident revisit
 * would hang for 30s waiting on a listener that can never fire.
 */

/**
 * Body renders inside `.accordion-body` unconditionally — browsers display:none the content when
 * `[open]` is unset, but PM's DOM is retained so children stay live per Precedent #30 (all user

/**
 * PM children stay live (Precedent #30) — they're just not painted. ── Strip rendering & index
 * space ──────────────────────────────────────────── The strip needs each Tab's `label` and a
 * stable `id` (for ARIA pairing).
 */

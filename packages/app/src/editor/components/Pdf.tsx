  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        /*
         * UPSTREAM(mozilla/pdf.js#18015): the `new Function` font/operator
         * compilation path and its `isEvalSupported` opt-out are both gone, so
         * there is no eval left here to harden.
         */

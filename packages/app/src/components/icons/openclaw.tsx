...
// silhouette so it tracks the dropdown row's text color and brightens on hover like
// every other brand icon. Antennae are currentColor strokes; the two eyes are punched
// out via a mask so the mark reads as a creature instead of a solid blob.

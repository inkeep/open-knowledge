// oxlint-disable ok/no-raw-html-interactive-element -- pre-rule backlog — the diff-open row target is a raw <button> awaiting shadcn migration; the Restore action already uses shadcn Button. Tracked at https://github.com/inkeep/open-knowledge/blob/main/lint-plugins/ok-rules/README.md#no-raw-html-interactive-element
